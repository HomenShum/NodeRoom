...
const report = { schema: 'noderoom-entry-observation/v1', startedAt: new Date().toISOString(), sourceCommit: '2b3e5bd718b80747f32257a8b8af5f15e2310699', sourceBindings: '../../E6f-noderoom-first-run/source-before.json', cells: [], externalRequests: [], errors: [], status: 'RUNNING' };
let browser;
