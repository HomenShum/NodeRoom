...
import { projectRoomArtifactsToNodeBook, roomArtifactProjectionRevision, updateRoomArtifactProjectionCache, type RoomArtifactProjectionCache } from "../src/notebook/NodeBookWorkspaceSurface";
...
for (let index = 0; index < iterations; index += 1) {
  ...
  roomArtifactProjectionRevision("scale-room", freshArtifacts);
