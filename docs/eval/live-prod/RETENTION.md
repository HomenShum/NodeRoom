...
- `live-prod-20260706T225336Z` is the current passing live-prod slate. It passed QA story, HMDA underwriting, HMDA verifier, uploaded artifact rendering, public `@nodeagent`, and deterministic generic ProofLoop browser. BTB is skipped by the provider preflight receipt because `OPENROUTER_API_KEY` is not present locally.
