...
Generated: 2026-07-03T21:58:00.043Z
...
| pass | `stop-hook-blocks-failing-gate` - Generated Stop hook blocks fake done while gate is failing | 0 | `C:\nvm4w\nodejs\node.exe <temp>/proofloop-npx-package-proof-1783115880044-bd193c4ded67c\stranger-vite-repo\.proofloop\hooks\stop-gate.mjs` |
| pass | `forgery-guard-blocks-gate-state` - Generated PreToolUse guard blocks forged proof-state writes | 2 | `C:\nvm4w\nodejs\node.exe <temp>/proofloop-npx-package-proof-1783115880044-bd193c4ded67c\stranger-vite-repo\.proofloop\hooks\pretooluse-guard.mjs` |
...
| pass | `posttooluse-records-forbidden-call` - PostToolUse logger records a redacted forbidden call | 0 | `C:\nvm4w\nodejs\node.exe <temp>/proofloop-npx-package-proof-1783115880044-bd193c4ded67c\stranger-vite-repo\.proofloop\hooks\posttooluse-log.mjs` |
