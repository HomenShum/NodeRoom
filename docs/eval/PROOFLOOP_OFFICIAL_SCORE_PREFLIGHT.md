...
Generated: 2026-07-12T19:02:25.838Z
Status: pass
Preflight paid provider calls: no
Preflight provider spend: $0.000000
Accepted scorer receipt spend: $8.081951
...
|---|---:|---|---|
| `free-discovery-receipt-present` | pass | 12 tool-capable free route(s) discovered. | `docs/eval/openrouter-free-model-discovery.json` |
...
| `free-gauge-has-usable-route-or-safe-skip` | pass | Gauge passed=5, skipped=0, failed=3. | `docs/eval/proofloop-free-openrouter-nodeagent-gauge.json` |
...
|---|---|---|---:|---|
| `finauditing` | `openai` | `gpt-5-mini` | $0.041812 | `docs/eval/proofloop-official-scores/finauditing.json` |
| `finch` | `openai` | `gpt-5-mini` | $1.368019 | `docs/eval/proofloop-official-scores/finch.json` |
| `workstreambench` | `google` | `google/gemini-3-flash-preview` | $6.672120 | `docs/eval/proofloop-official-scores/workstreambench.json` |
...
| `finch` | Upstream Finch content_parts rendering or an accepted canonical GPT-5-mini judge/scorer receipt is missing. | `npm run benchmark:proofloop:official-preflight -- --strict && npm run benchmark:proofloop:adapter-blockers -- --id finch --strict` | Refresh the typed adapter blocker receipt after importing upstream scorer output.<br>Do not label OpenRouter proxy judge evidence as Finch official score evidence. |
