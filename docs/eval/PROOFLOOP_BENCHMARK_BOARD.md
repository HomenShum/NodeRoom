...
Generated: 2026-07-06T07:05:07.214Z
...
- Product-path proven: 5
- Product-path ready to run: 3
...
| `proximitty-underwriting-pr0` | product_suite | ready_to_run | not_applicable | `proofloop/suites/proximitty-underwriting-pr0.json` | Synthetic underwriting suite; do not label as an official finance benchmark score. |
