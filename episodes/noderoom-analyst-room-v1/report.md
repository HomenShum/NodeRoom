...
| 4 | brief | **live footage** | `docs/walkthroughs/brief.mp4` — the Today's Brief notebook tab (`TodaysBrief.tsx`, `specs.ts#brief`) over packet engine `bankerCoachPacket.ts` |
