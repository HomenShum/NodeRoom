...
> **Benchmark claims come ONLY from this generated block and the live board**
> ([`docs/eval/PROOFLOOP_BENCHMARK_BOARD.md`](docs/eval/PROOFLOOP_BENCHMARK_BOARD.md)).
> Benchmark numbers in the prose further down this README are a historical snapshot
> and may be stale — do not quote them. Status vocabulary: `docs/eval/CERTIFICATION_GATES.md`
...
[Full proof video](episodes/noderoom-proof-release-v1/renders/short.mp4) | [Storyboard](episodes/noderoom-proof-release-v1/storyboard.yaml) | [Media manifest](episodes/noderoom-proof-release-v1/media-manifest.json) | [Visual judge: publish, 15/16](episodes/noderoom-proof-release-v1/judge.md)
