/* ============================================================================
   ...
   Ported from the design prototype (na-chat.jsx).
   ============================================================================ */
...
function withMentions(text: string): React.ReactNode[] {
  return text.split(/(@\w+)/).map((part, i) => (part[0] === "@" ? React.createElement("span", { key: i, className: "mention" }, part) : part));
}
  ...
  return React.createElement(
    ...
    msgs.map((m) => {
      if (m.kind === "msg")
        return React.createElement(
          "div",
          { key: m.id, className: "na-rmsg" },
          avatar(m.who),
          React.createElement("div", { className: "na-rmsg-main" }, head(m.who, m.t), React.createElement("div", { className: "na-rmsg-text" }, withMentions(m.text))),
        );

      if (m.kind === "status")
        return React.createElement(
          "div",
          { key: m.id, className: "na-rmsg agent" },
          avatar(m.who),
          React.createElement(
            "div",
            { className: "na-rmsg-main" },
            head(m.who, m.t),
            React.createElement("div", { className: "na-status" }, React.createElement("span", { className: "na-pulsedot" }), m.text),
          ),
        );
      ...
      if (m.kind === "summary")
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "na-stats", style: { marginTop: 9 } },
              m.stats.map((s, i) =>
                React.createElement("div", { key: i, className: "na-stat" }, React.createElement("b", { className: "mono", style: { fontSize: 13 } }, s.v), React.createElement("span", null, s.l)),
              ),
            ),
          ),
        );
      ...
      if (m.kind === "artifact")
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "button",
              { className: "na-artlink", onClick: () => ctx.openRow() },
              React.createElement("span", { className: "ai" }, Ico("table")),
              React.createElement("span", null, React.createElement("strong", null, m.title), React.createElement("span", null, m.meta)),
...
// ── AGENT CONVERSATION ──────────────────────────────────────────────────
export function AgentChat({ ctx }: { ctx: MobileCtx }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "na-lanes" },
      React.createElement("button", { className: "na-lane priv", "data-active": lane === "private", onClick: () => ctx.setAgentLane("private") }, Ico("lock"), "Your agent"),
      React.createElement("button", { className: "na-lane room", "data-active": lane === "room", onClick: () => ctx.setAgentLane("room") }, Ico("users"), "Room agent"),
    ),
    ...
    React.createElement(
      ...
      msgs.map((m) => {
        ...
        if (m.variant === "status")
          return React.createElement("div", { key: m.id, className: "na-agent-status" }, React.createElement("span", { className: "na-pulsedot" }), m.text);
        if (m.variant === "summary")
          return React.createElement(
            "div",
            { key: m.id, className: "na-card accent" },
            React.createElement(
              "div",
              { className: "na-card-head accent" },
              React.createElement("div", { className: "na-card-title" }, React.createElement("strong", null, m.title), React.createElement("span", null, m.sub)),
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                { className: "na-stats" },
                m.stats.map((s, i) =>
                  React.createElement("div", { key: i, className: "na-stat" }, React.createElement("b", { className: s.mono ? "mono" : "", style: { fontSize: 15 } }, s.v), React.createElement("span", null, s.l)),
                ),
              ),
              React.createElement("button", { className: "na-btn primary full", style: { marginTop: 10 }, onClick: () => ctx.openSheet("plan") }, Ico("arrowRight"), "Open work plan"),
            ),
          );
        // text
        return React.createElement(
          "div",
          { key: m.id, className: "na-bubble agent" },
          React.createElement(
            "div",
            { className: "na-bubble-who" },
...
// ── UNIVERSAL COMPOSER ──────────────────────────────────────────────────
export function Composer({ ctx }: { ctx: MobileCtx }) {
  ...
  return React.createElement(
    ...
    showQuick &&
      React.createElement(
        "div",
        { className: "na-quick" },
        D.QUICK_PROMPTS.map((q, i) => React.createElement("button", { key: i, onClick: () => ctx.runQuick(q) }, Ico(q.icon), q.text)),
      ),
    ...
    React.createElement(
      ...
      { className: "na-modes" },
      MODES.map((id) =>
        React.createElement("button", { key: id, className: "na-mode", "data-mode": id, "data-active": m === id, onClick: () => ctx.setComposerMode(id) }, Ico(modeMeta[id].icon), modeMeta[id].label),
      ),
    ),
    ...
    ctx.listening
      ? React.createElement(
          "div",
          { className: "na-composer-row" },
          React.createElement(
            "div",
            { className: "na-listening" },
            React.createElement(
              "span",
              { className: "na-wave" },
...
export function JobsSheet({ ctx }: { ctx: MobileCtx }) {
  ...
  const job = (j: Job, kind: "running" | "queued" | "completed") =>
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Pill, { tone: kind === "running" ? "accent" : kind === "queued" ? "warn" : "ok" }, kind === "running" ? "running" : kind === "queued" ? "queued" : "done"),
      ),
      React.createElement("div", { className: "na-job-meta" }, meta(j.cost), j.eta && meta(j.eta), j.route && meta(j.route), j.trace && meta(j.trace)),
      kind === "running" && React.createElement("div", { className: "na-prog" }, React.createElement("i", { style: { width: (j.pct || 50) + "%" } })),
      kind === "running" &&
        React.createElement(
          "div",
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "na-sheet-head" },
      React.createElement("div", { className: "st" }, React.createElement("strong", null, "Agent jobs"), React.createElement("span", null, "Queue · running · completed")),
      React.createElement("button", { className: "na-close", onClick: ctx.closeSheet, "aria-label": "Close" }, Ico("x")),
    ),
    React.createElement(
      "div",
