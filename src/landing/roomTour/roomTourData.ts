...
export const STEPS: Step[] = [
  { id: "landing", label: "NodeAgent", kicker: "01 · Surface",
    title: "The room entry surface", screen: "landing",
    file: "apps/web · scratchnode.live shell",
    blurb: "Start with one room URL. From here you host a room or join with a code, then satisfy the room's access policy." },
  ...
  { id: "join", label: "Join by code", kicker: "03 · Identity",
    title: "Join with a room code", screen: "join",
    file: "rooms · account-bound membership",
    blurb: "A member pastes the code and confirms their identity when the room requires account protection." },
