...
export const PEOPLE: Record<string, Person> = {
  ...
  quokka: { id: "quokka", name: "guest · quokka", short: "qk", role: "Guest",        kind: "human", color: "#5B8F71", anon: false },
...
export const STEPS: Step[] = [
  ...
  { id: "join", label: "Member join", kicker: "03 · Identity",
    title: "Members join with a code", screen: "join",
    file: "rooms · authenticated membership",
    blurb: "A signed-in member pastes the code and picks a display name. Membership is bound to the account and scoped to this room." },
