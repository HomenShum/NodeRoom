 ...
 * This is a DQC-inspired numeric-inconsistency lane related to the kind of
 * structured XBRL checks FinAuditing (arXiv:2510.08886) studies. It is NOT the
 * official XBRL-US DQC rule set and it is NOT the official FinAuditing score
 * (FinAuditing includes FinSM, FinRE, and FinMR tasks over their dataset).
 * officialScoreClaim MUST stay false everywhere this is surfaced.
 *
...
export const SEC_XBRL_AUDIT = {
  ...
  benchmarkInspiration: "FinAuditing (arXiv:2510.08886) + XBRL-US DQC-inspired identity checks",
