...
export const FRAME_TOOL_ALLOWLIST: Record<ReasoningFramePhase, string[]> = {
  ...
  execute: ["fetch_source", "capture_source", "linkup_search", "you_search", "you_research", "you_finance_research", "github_profile", "source_compare_claim", "read_notebook", "append_notebook_outline", "write_locked_cell_results", "workbook_session", "update_wiki", "skill_search", "load_skill"],
  verify: ["source_compare_claim", "okf_read_concept", "read_range", "reconcile_cell", "workbook_session"],
