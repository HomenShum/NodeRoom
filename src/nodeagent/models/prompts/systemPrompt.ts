...
3. PREFLIGHT. If execute_verified_workbook_plan is available and inspect_workbook returned a complete high-confidence formula/value contract, call it with the same complete instruction and artifactId; it performs the remaining preflight, managed write, and post-verification without making you echo a large operation array. Otherwise call verify_workbook with afterWrite=false for formula repair or multi-cell plans. Repair any needs_repair result before writing.
